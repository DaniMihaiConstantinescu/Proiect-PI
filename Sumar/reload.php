...
$id = $params["id"];
$nume = "";
$render = getRender($params['culoare']);
$incluse = getIncluse($params['echipare']);
$optiuni = explode(",", $params['id']);


$detalii = array();

$total = getTotal($params['echipare'], $params['motorizare'], $params['culoare'], $nume, $optiuni, $incluse, $detalii);
...
function fin(&$txt)
{
    ...
    <div class=\"total\" style=\" margin-bottom:3em \"> Total: " . $total . "$ </div>
    ...
    <div class=\"programare\">Programati o intalnire cu un dealer</div>
    -->
