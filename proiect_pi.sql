...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1008310610ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=proiect+pi&table=dealeri">`proiect pi`.`dealeri`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=proiect+pi&table=culori">`proiect pi`.`culori`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=proiect+pi&table=promotii">`proiect pi`.`promotii`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=proiect+pi&table=masini">`proiect pi`.`masini`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=proiect+pi&table=programari">`proiect pi`.`programari`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=proiect+p3&table=cheltuieli">`proiect p3`.`cheltuieli`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=proiect+pi&table=optiuni">`proiect pi`.`optiuni`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=proiect+pi&table=echipari">`proiect pi`.`echipari`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=proiect+pi&table=motorizari">`proiect pi`.`motorizari`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="74222550416a51423e3f4d526542543f">
